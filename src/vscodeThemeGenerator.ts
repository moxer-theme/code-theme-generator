...
export class VscodeThemeGenerator implements IThemeGenerator {
  public generateTheme(name: string, colorSet: IColorSet): string {
    ...
    const fallbackColorSet = generateFallbackColorSet(
      colorSet.base,
      colorSet.type
    );
    ...
    tokenRules.forEach(generator => {
      const color =
        generator.color(colorSet) || generator.color(fallbackColorSet);
      if (color) {
  ...
  private _applyWorkbenchColors(
    theme: IVscodeJsonTheme,
    colorSet: IColorSet
  ): void {
    const background1 = (colorSet.type === 'light' ? lighten : darken)(
      colorSet.base.background,
      0.2
    );
    const background2 = colorSet.base.background;
    const background3 = (colorSet.type === 'light' ? darken : lighten)(
      colorSet.base.background,
      0.2
    );
    const background4 = (colorSet.type === 'light' ? darken : lighten)(
      colorSet.base.background,
      0.4
    );
    const background5 = (colorSet.type === 'light' ? darken : lighten)(
      colorSet.base.background,
      0.6
    );
    ...
    theme.colors['list.activeSelectionBackground'] = addAlpha(
      colorSet.base.color1,
      0.5
    );
    ...
    theme.colors['activityBar.dropBackground'] = addAlpha(
      colorSet.base.color1,
      0.5
    );
    ...
    theme.colors['badge.foreground'] = contrast(
    ...
    theme.colors['editorGroup.dropBackground'] = addAlpha(
      colorSet.base.color1,
      0.5
    );
    ...
    if (colorSet.ui.selectionHighlight)
      theme.colors['editor.selectionHighlightBackground'] =
        colorSet.ui.selectionHighlight;
    ...
    if (colorSet.ui.wordHighlight)
      theme.colors['editor.wordHighlightBackground'] =
        colorSet.ui.wordHighlight;
    ...
    if (colorSet.ui.wordHighlightStrong)
      theme.colors['editor.wordHighlightStrongBackground'] =
        colorSet.ui.wordHighlightStrong;
    // editor.findMatchBackground: Color of the current search match.
    if (colorSet.ui.currentFindMatchHighlight)
      theme.colors['editor.findMatchBackground'] =
        colorSet.ui.currentFindMatchHighlight;
    // editor.findMatchHighlightBackground: Color of the other search matches.
    if (colorSet.ui.findMatchHighlight)
      theme.colors['editor.findMatchHighlight'] =
        colorSet.ui.findMatchHighlight;
    // editor.findRangeHighlightBackground: Color the range limiting the search.
    if (colorSet.ui.findRangeHighlight)
      theme.colors['editor.findRangeHighlightBackground'] =
        colorSet.ui.findRangeHighlight;
    ...
    if (colorSet.ui.activeLinkForeground)
      theme.colors['editorLink.activeForeground'] =
        colorSet.ui.activeLinkForeground;
    ...
    theme.colors['panelTitle.activeBorder'] = addAlpha(
      colorSet.base.foreground,
      0.5
    );
    ...
    theme.colors['panelTitle.inactiveForeground'] = addAlpha(
      colorSet.base.foreground,
      0.5
    );
    ...
    theme.colors['statusBarItem.activeBackground'] = addAlpha(
      colorSet.base.color1,
      0.5
    );
    ...
    if (colorSet.terminal.brightMagenta)
      theme.colors['terminal.ansiBrightMagenta'] =
        colorSet.terminal.brightMagenta;
    ...
    if (colorSet.terminal.brightYellow)
      theme.colors['terminal.ansiBrightYellow'] =
        colorSet.terminal.brightYellow;
